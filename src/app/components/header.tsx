...
export default function Header() {
  return (
    <header className="p-4 sm:p-6 text-white bg-blue-600">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between">
        <div className="flex items-center space-x-4">
          <img
            src="/image/profile2.jpg"
            alt="Profile Pic"
            width={60} // Default smaller size for mobile
            className="border-2 border-white rounded-full sm:w-20" // Larger size for small screens and up
          />
          <h1 className="text-lg sm:text-2xl font-bold">Medical Branch</h1>
        </div>
        <nav className="mt-4 sm:mt-0">
          <ul className="flex flex-col sm:flex-row items-right sm:gap-6 gap-3">
            <li>
